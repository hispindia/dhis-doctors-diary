...
function loginService(){
    ...
    this.signin = function(username,
        ...
        api.getReq(
            `users?filter=userCredentials.username:eq:${username}&fields=fields=id,name,displayName,organisationUnits[id,code,name,ancestors[id,level,name]],userAccesses,userCredentials[id,name,username],userGroups[id,code,name]`,
